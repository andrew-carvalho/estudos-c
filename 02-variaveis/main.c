...
int main() {
  ...
  */
  ...
  /*
  A função printf() consegue imprimir variáveis mas para isso deve-se usar
  indicadores de formatação especiais para cada tipo de dado:
  - %d ou %i -> int
  - %f ou %F -> float
  - %lf -> double
  - %c -> char
  ...
  */
  ...
  /*
  A função sizeof() retorna o tamanho de um dado na memória em bytes (o tamanho
  ...
  */
  ...
  /*
  Existe uma maneira de duplicar o tamanho de uma variável com a adição dos
  seguintes modificadores antes do tipo:
  - long
  - long long
  */
  long int example = 10;
