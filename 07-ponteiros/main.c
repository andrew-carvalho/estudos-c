...
int main() {
  ...
  */
  ...
  /*
  Para acessar o valor armazenado no endereço no ponteiro é preciso
  de-referenciar ele Em C podemos usar o operador *
  */
  printf("%p = %d\n", p, *p);
  ...
  a linguagem C cuida de pular os bytes necessários e acessar o próximo elemento
  automaticamente
  */
